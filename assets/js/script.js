...
// ------- Twitter Feed Fetch -------- //
var startYear = getDates()[1];
var startMonth = getDates()[0];
var startDay = getDates()[2];

var endYear = getDates()[4];
var endMonth = getDates()[3];
var endDay = getDates()[5];

var hashtag = 'doge'; // value should be dynamically generated by respective crypto main card button
var startDate = startYear + "-" + startMonth + "-" + startDay; //  dynamically generated by new Date();
var endDate = endYear + "-" + endMonth + "-" + endDay; // dynamically generated by new Date() + 1;
